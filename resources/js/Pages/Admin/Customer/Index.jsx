        ...
        <AuthenticatedLayout header="Data Customer">
            ...
            <div className="bg-white rounded-2xl shadow-sm shadow-gray-200/50 border border-gray-100 overflow-hidden">
                <div className="p-4 sm:p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                    ...
                    <Link href={route('admin.customers.create')} className="px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 transition shadow-sm">
                        + Tambah Customer
                    </Link>
                </div>
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {customers.data.map(customer => (
                                <tr key={customer.id} className="hover:bg-indigo-50/30 transition duration-150">
                                    ...
                                    <td className="px-6 py-4 text-right space-x-2">
                                        <Link href={route('admin.customers.edit', customer.id)} className="text-indigo-600 hover:text-white hover:bg-indigo-600 transition-colors bg-indigo-50 border border-indigo-100 px-3 py-1.5 rounded-md font-medium text-xs uppercase tracking-wide inline-block">Edit</Link>
